...
impl From<RavenAction> for TilingCommand {
    ...
    fn from(action: RavenAction) -> Self {
        match action {
            ...
            RavenAction::SetMaximize {
                window_id,
                maximized,
            } => TilingCommand {
                action: "set_maximize".to_string(),
                window_id: Some(window_id),
                x: None,
                y: None,
                width: None,
                ...
                target_ws: None,
                direction: None,
                floating: Some(maximized),
                keep_above: None,
            },
            RavenAction::CloseWindow { window_id } => TilingCommand {
            ...
            RavenAction::RequestSync => TilingCommand {
                action: "request_sync".to_string(),
                window_id: None,
                x: None,
                y: None,
                width: None,
