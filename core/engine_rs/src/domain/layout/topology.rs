...
mod tests {
    ...
    fn test_pip_detection_and_dynamic_float_precedence() {
        ...
        let win_normal =
            mock_window("editor").with_class_and_caption("code".to_string(), String::new(), false, "Editor".to_string());
        let win_pip_by_title = mock_window("firefox_pip")
            .with_class_and_caption("firefox".to_string(), String::new(), false, "Picture-in-Picture".to_string());
        let win_pip_by_rule = mock_window("vlc_video")
            .with_class_and_caption("vlc".to_string(), String::new(), false, "Movie.mp4".to_string());
